...
import { FONTS, LAYOUT_TYPE } from "@dscl-ttg/constants";
import clsx from "clsx";
import { useRecoilValue } from "recoil";
import { settingsSelector } from "@dscl-ttg/store";
import React, { memo, ReactNode } from "react";

type VerticalNavItemProps = any;
  ...
  return (
    <ListItem
      className={clsx("menu-vertical-item", {
        "rounded-reverse": menuStyle == "rounded-reverse",
        "standard-menu": menuStyle === "standard-menu",
      })}
      sx={{
        height: 40,
        my: 0.25,
